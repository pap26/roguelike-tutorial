...
public class DunskuBuilder {
    private int width;
    private int height;
    private Tile[][] tiles;

    public DunskuBuilder(int width, int height) {
        this.width = width;
        this.height = height;
    ...
    //Randomeja cave-levelejä, tiilet sekaisin, tsekataan seinät ja lattiat

    private DunskuBuilder randomizeTiles() {
